...
const required = [
  ...
  'src/main.js', 'src/style.css', 'src/core/bokeh-response.js', 'src/core/clipboard.js', 'src/core/focus-depth.js', 'src/core/particle-afterimage.js', 'src/core/ring-particles.js', 'src/core/water-surface.js', 'src/core/particle-load-guard.js', 'src/core/particle-load-planner.js', 'src/pyro/presets.js', 'src/pyro/patterns.js',
