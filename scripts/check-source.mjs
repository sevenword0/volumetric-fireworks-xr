...
const required = [
  ...
  'src/main.js', 'src/style.css', 'src/core/focus-depth.js', 'src/core/particle-load-guard.js', 'src/core/particle-load-planner.js', 'src/pyro/presets.js', 'src/pyro/patterns.js',
